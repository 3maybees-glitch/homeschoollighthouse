...
const rawListings: SeedInput[] = [
  ...
  { title: "TheHomeSchoolMom", listingType: "resource_hub", format: "online", priceType: "free", websiteUrl: "https://thehomeschoolmom.com", philosophies: ["eclectic"], values: ["parent_led"], ageMin: 4, ageMax: 18, description: "Curriculum reviews, local homeschool law guides, and planning resources for homeschool families." },
  { title: "Homeschool.com", listingType: "resource_hub", format: "online", priceType: "free", websiteUrl: "https://www.homeschool.com", philosophies: ["eclectic"], ageMin: 4, ageMax: 18, description: "Curriculum finder, getting-started guides, and homeschool articles from one of the web's oldest homeschool directories." },
  { title: "Freedom Homeschooling", listingType: "resource_hub", format: "online", priceType: "free", websiteUrl: "https://freedomhomeschooling.com", philosophies: ["eclectic"], religions: ["secular"], ageMin: 4, ageMax: 18, description: "Curated directories of free online homeschool courses and electives." },
